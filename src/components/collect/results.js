        ...
        <>
            ...
            <section class="breadcrumb-section section top-section">
                <div class="container">
                    <ul>
                        ...
                        <li class="bread-seperator"> <img class="img-fluid" src="../../assets/images/icons/breadcrumb-arrow.png" alt="breadcrumb" /> </li>
                        <li class="bread-child">AUCTION RESULTS</li>
                    </ul>
                </div>
            </section>
            ...
            <section class="page-title-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1 class="page-title list-inline-item">Auction Results</h1>
                    ...
                    <div class="grid">
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/at-the-dia-beacon-contemporary-art-museum-2021-08-29-01-04-32-utc.jpg")` }}>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/arno-senoner-fekOj0LCFQY-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/antenna-jqh0GEvuNBY-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/andrea-contieri-MsfiDM9Onfg-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
