        ...
        <>
            ...
            <section class="breadcrumb-section section top-section">
                <div class="container">
                    <ul>
                        ...
                        <li class="bread-parent">COMING SOON</li>
                        <li class="bread-seperator"> <img class="img-fluid" src="../../assets/images/icons/breadcrumb-arrow.png" alt="breadcrumb" /> </li>
                        <li class="bread-child">ART</li>
                    </ul>
                </div>
            </section>
            ...
            <section class="page-title-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1 class="page-title list-inline-item">Art Results</h1>
                    ...
                    <div class="grid">
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/birmingham-museums-trust-p00MgXaa6as-unsplash.jpg")` }}>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/birmingham-museums-trust-rlj8fwCjsp8-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/birmingham-museums-trust-5F3u0j6s6pM-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
                        ...
                        <div class="grid-item">
                            <div class="grid-item-content">
                                <a href='place-bid'>
                                    <div class="card p-0 hover-shadow" style={{ backgroundImage: `url("/assets/images/museums/birmingham-museums-trust-qYM3UdDslbk-unsplash.jpg")` }}>
                                        <div class="current-overlay"></div>
                                        <div class="card-body">
                                            <div class="right-side">
                                                <div class="current-label">Ends in 5 Days</div>
